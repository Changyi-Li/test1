### Delivery address
In this box you see the company's delivery address. When needed, you can change the address information for the specific purchase order. Here you can also change to a different delivery address. You can also see and modify the company's mailing address for the inquiry in question.
The address information is by default loaded from the Company information procedure, or from the Users procedure if you’ve entered a default delivery address. If you have installed the option Warehouse, the address information is loaded form the (receiving) warehouse selected in the Miscellaneous box.
...
#### Change address
By using the Change address button ![](https://help.monitorerp.cn/CN-MONITOR_G5/en-us/Content/Resources/Images/button_more_info.png) it is possible to change the delivery address for the order in question. You can choose to load the new address from Current supplier, Other supplier, Customer, or Company (warehouse).
If you have selected to load the delivery address from the customer or company and they have alternative delivery addresses, you will see the number of alternative delivery addresses on the button within brackets.
...
#### Mailing address
By clicking the button Mailing address ![](https://help.monitorerp.cn/CN-MONITOR_G5/en-us/Content/Resources/Images/button_more_info.png) you see the company's mailing address. When needed, you can change the address information for the specific purchase order.
