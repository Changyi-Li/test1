### Incoming payments
In this box you can manually register the invoices that have been paid, or you can load invoices from the [List](tListRegisterViaList.htm) tab. At the bottom of the box, you see totals of the amounts on the rows.
