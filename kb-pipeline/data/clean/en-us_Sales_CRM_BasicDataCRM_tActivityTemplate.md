...
#### Type
Here you choose which type of template you wish to create. The following types are available: Customer agreement, Blanket order – Sales, Customer, Customer order, and Quote.
Templates

#### Default
Here you select which activity template should be default.
Please note! Default activity templates for Customer order, Blanket order – Sales, Customer agreement, and Quote, are configured in the Order types procedure.
...
Uses the person responsible for customer or the seller (information entered in the customer register) as responsible for the activity. (This applies to activity templates for customer.)

#### Reference
Uses the customer order's reference as responsible for the activity. (This applies to activity templates for customer order.)
...
#### Due date from registration
Here you can enter a due date from registration. (This applies to activity templates for customer.)
