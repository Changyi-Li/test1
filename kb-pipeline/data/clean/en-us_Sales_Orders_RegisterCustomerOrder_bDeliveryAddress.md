### Delivery address
In this box you see the customer's delivery address. When needed, you can change address information for the specific order. Here you can also change to a different delivery address. The delivery address determines different terms. It also determines posting and VAT. You can also see and change the customer's mailing address for the order in question.
The address information is by default loaded from the Customer register procedure.
...
If there are alternative delivery addresses, you will see the number of addresses within parenthesis on this button. For the order it is possible to change to another delivery address, if needed, for the customer in question. It is also possible to select another customer's or supplier's delivery address, or the company's delivery address.
The alternative delivery address determines some information on the order. This information will be updated when you change supplier if it differs from the information on the default delivery address. This is information such as delivery terms, delivery method, transport time, customer group, VAT group, communication information, etc. Read more about what information is concerned under the Alternative delivery addresses heading in the section [Delivery address](../../Customers/CustomerRegister/bDeliveryAddress.htm) in the online help function for the Customer register procedure.
Regarding the communication information, this is only changed if you change to another delivery address for the customer in question, not if you change to another customer's or supplier's address, or the company's delivery address.
> If you have entered exception VAT registration number, changing the delivery address can also lead to the recipient’s VAT registration number being changed for the order/invoice.

#### Mailing address
By clicking the button Mailing address ![](https://help.monitorerp.cn/CN-MONITOR_G5/en-us/Content/Resources/Images/button_more_info.png) you see the customer's mailing address. When needed, you can change the address information for the specific order.
