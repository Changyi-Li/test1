### Sales overhead
Under this tab you only manage sales overhead mark-ups. The general sales overhead mark-up has a fixed number and cannot be deleted or renamed. You can create new mark-ups by adding more rows in the table.
...
#### Mark-up
The mark-up in percent. The value can be entered with two decimals. It is possible to enter negative values.
