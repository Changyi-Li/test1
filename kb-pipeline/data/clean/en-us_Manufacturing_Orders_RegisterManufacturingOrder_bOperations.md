...
#### Supplier
If the row refers to a subcontracting work center, you will see the supplier number which was entered for the work center. It is also possible to change to another supplier in this field. By using the LookupThe Lookup feature is a powerful search tool which allows you to search and load information from large registers. You open the Lookup feature by clicking on the dropdown button or by using F4 on your keyboard. feature, you can search for subcontract suppliers in the supplier register.
