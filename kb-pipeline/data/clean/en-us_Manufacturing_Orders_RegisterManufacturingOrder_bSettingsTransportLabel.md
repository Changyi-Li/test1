...
#### Document
In this field you select the transport label that should apply for the transport label prior to reporting.
...
The default transport label is configured under the Manufacturing tab in the Part register procedure.
...
If you in the procedure Document templates choose the module Manufacturing, you can add variants which will then become possible to use for this printout. These variants should be added for the document types Transport label, manufacturing, prior to reporting – A4, A5 and Labels.
