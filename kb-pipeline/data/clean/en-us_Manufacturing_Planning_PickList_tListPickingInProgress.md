...
#### Pick list number
Here you enter the number of the pick list.

#### Printed when
Here you can see the date and time when the pick list was printed.

#### Printed by
In this column you see the name of the person or user that printed the pick list.

#### Created when
Here you see the date and time when the pick list was created.

#### Created by
Here you see the name of the person or user that created the pick list.
