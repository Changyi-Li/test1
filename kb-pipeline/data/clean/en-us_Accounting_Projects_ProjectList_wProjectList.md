## Project list
In this procedure you can create a list of existing projects. The list contains basic information about each project. Most of this information can be updated in the list.
List type

#### Standard
In this procedure there is only a standard list type. It is a simple list of the existing projects. The list can be sorted by general information or be grouped by project type.
Presentations
