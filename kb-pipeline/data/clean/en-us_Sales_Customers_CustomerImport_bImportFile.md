### Import file
The standard format template only contains customer number and customer name. If the purpose of the customer import is to update suppliers, it is possible to create format templates without customer names.
...
The standard format template only contains customer number and customer name.
