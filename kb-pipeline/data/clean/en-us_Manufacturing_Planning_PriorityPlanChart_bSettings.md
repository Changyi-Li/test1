...
#### Show suggestions
With this setting you decide if manufacturing order suggestion should be shown in priority plan chart.

#### Replan from
Here you decide how the replanning should be made in the priority plan chart. You can either replan from Finish date or from Start date.
