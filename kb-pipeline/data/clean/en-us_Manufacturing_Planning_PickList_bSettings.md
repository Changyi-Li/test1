...
#### Include
With this setting you decide if only Material, only Tools, or if both Material and tools should be included in the pick list. The last of the options will result in two pick lists. One pick list for material and one pick list for tools.

#### Only cleared material
With this setting you determine if only cleared material will be displayed under the List tab and can thereby be included in the pick list.

#### Only material without shortage
...
#### Not stock updated
With this setting you decide if parts which are not stock updated should be included in the pick list.

#### Save material clearance when saving pick list
By activating this setting, a material clearance is performed in the background and the clearance is being saved on the material rows when the pick list is created by saving under the List tab.

#### Pre-select "Include"
This setting determines whether or not the “Include” box should be checked by default for all rows in the list/result.
This setting is not available for the list type Split pick list.
