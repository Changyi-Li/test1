...
#### Pick list number
Here you see the number of the pick list.

#### Warehouse
This column is available if you have selected the list type Pick list. Here you see the warehouse to which the pick list belongs.

#### Split pick list
This column is available if you have selected the list type Split pick list. Here you see how the pick lists are configured to be split. A tooltip in the columns displays this information.
