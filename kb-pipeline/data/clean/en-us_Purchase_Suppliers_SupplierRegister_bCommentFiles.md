### Comment/Files
In this box you can enter a comment for the supplier, and also link external files. These comments and linked files are not displayed or printed on any documents, but they are accessible in e.g. the Register inquiry, Register purchase order, and Register supplier invoice procedures.
