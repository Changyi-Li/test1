### Delivery address
In this box you see the receiving warehouse's delivery address. When needed, you can change the address information for the specific stock order. Here you can also change to a different delivery address. You can also see and modify the receiving warehouse's mailing address for the stock order in question.
This address information is loaded from the warehouse selected in the Customer field on the header row.
...
If there are alternative delivery addresses, you will see the number of addresses within parenthesis on the button. By clicking this button you can, when needed, change delivery address for the stock order in question. It is also possible to select another customer's, supplier's, or the company's delivery address.
...
#### Mailing address
By clicking the button Mailing address ![](https://help.monitorerp.cn/CN-MONITOR_G5/en-us/Content/Resources/Images/button_more_info.png) you see the receiving warehouse's mailing address. When needed, you can change the address information for the specific stock order.
