### Phases
Here you register different phases that can occur in projects. When you install the system, one phase is included as an example. You add phases in activity templates. Then you add different activities to each phase in the activity templates.
...
#### Responsible
Here you enter who is responsible for the phase in question. It is possible to select a user account as responsible.
