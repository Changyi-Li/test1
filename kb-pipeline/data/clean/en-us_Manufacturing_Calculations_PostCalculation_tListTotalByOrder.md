...
Under this tab you will see all the selected orders for which you can perform a post-calculation, if you have selected the list type Total by order. If you have selected the list type Part (mean price calculation), you will see the selected parts for which you can perform mean price calculation. You can expand each part and see detailed information about the manufacturing orders that exist for each respective part.
