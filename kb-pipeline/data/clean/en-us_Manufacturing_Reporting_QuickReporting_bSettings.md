...
#### Report time
In the Quick reporting list you report time for operations on all levels with the planned time for the quantity that you enter to be reported in the list.
In the Report remaining list you report time for operations on all levels with the planned time for the remaining quantity in the list.

#### Delete remaining
The remaining quantity of operations on all levels or the remaining quantity of material on all levels, respectively, will be deleted. That is, the remaining quantity of the order will be set to 0 (zero).
