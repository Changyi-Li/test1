...
If you have the option Warehouse it is also possible to select document variants for stock order.

#### Linked files
With this setting you determine that files linked to parts on order rows and files linked to orders, will be printed together with order confirmations and delivery notes.
