### Delivery address
In this box you see the company's delivery address. When needed, you can change the address information for the specific inquiry. Here you can also change to a different delivery address. You can also see and modify the company's mailing address for the inquiry in question.
The address information is by default loaded from the Company information procedure. If you have installed the option Warehouse, the address information is loaded form the (receiving) warehouse selected in the Miscellaneous box.
...
By using the button Change delivery address ![](https://help.monitorerp.cn/CN-MONITOR_G5/en-us/Content/Resources/Images/button_more_info.png) it is possible to change the delivery address for the inquiry in question. You can choose the load the new address from Current supplier, Other supplier, Customer, and Company (warehouse).
If you have selected to load the delivery address from the customer or company and they have alternative delivery addresses, you see the number of alternative delivery addresses on the button within brackets.
The selected delivery address determines some information on the inquiry. This information will be updated when you change supplier if it differs from the information on the default delivery address. The following information is updated: delivery terms, delivery method, goods receiver reference, customer number (shipping agent), transport time, destination, place of terms of delivery, customer group, VAT group, and communication information.

#### Mailing address
By clicking the button Mailing address ![](https://help.monitorerp.cn/CN-MONITOR_G5/en-us/Content/Resources/Images/button_more_info.png) you see the company's mailing address. When needed, you can change the address information for the specific inquiry.
