### C/I groups
Here you register cost/income groups. With cost/income groups you can group the costs and income of a project to get a better overview. This is especially useful if you have many cost/income types. You select which types of cost/income that should be grouped under each C/I group under the Costs/Income tab. The setting means that values for the selected cost/income types will be added together under the selecetd C/I group under the Costs/Income tab in the Project register procedure.
