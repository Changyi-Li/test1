### Import file
The standard format template only contains supplier number and supplier name. If the purpose of the supplier import is to update suppliers, it is possible to create format templates without supplier names.
