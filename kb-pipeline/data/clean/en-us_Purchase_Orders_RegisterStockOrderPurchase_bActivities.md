### Activities
Here you see and add activities regarding the stock order.
...
#### Activity
Here you select an activity. Activities must first be registered in the Activities table in the Basic data With "basic data" we refer to the static records in a database, for example parts, customers, users, work centers, etc. – SRM procedure.
