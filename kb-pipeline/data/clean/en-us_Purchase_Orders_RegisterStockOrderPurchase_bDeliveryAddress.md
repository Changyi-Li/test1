### Delivery address
In this box you see the receiving warehouse's delivery address. When needed, you can change the address information for the specific stock order. Here you can also change to a different delivery address. You can also see and modify the sending warehouse's mailing address for the stock order in question.
The address information is by default loaded form the (receiving) warehouse selected in the Miscellaneous box.
