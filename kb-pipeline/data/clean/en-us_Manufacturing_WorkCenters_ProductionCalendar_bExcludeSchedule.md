...
#### Exception schedule
Here you can enter the schedule which should be the exception schedule for the marked days in the calendar view. When you save in the procedure, the calendar view becomes updated with the schedule changes.

#### Number of dates
Here you see the number of dates that have been selected per calendar in the calendar view.

#### Work center
On this button you will see a number within parenthesis which indicates how many work centers that have been selected to be included in the exception from schedule. If you click the button, you can see the work centers in question.
