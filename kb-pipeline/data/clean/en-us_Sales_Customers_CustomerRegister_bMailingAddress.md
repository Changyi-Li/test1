### Mailing address
In this box you enter the mailing address for the customer. This information will also be set as default in the Delivery address box when registering a new customer, but it can be changed in that box.
